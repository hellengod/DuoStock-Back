...
-- CreateEnum
CREATE TYPE "StockMovementType" AS ENUM ('ENTRY', 'SALE', 'MANUAL_OUTPUT', 'ADJUSTMENT', 'RETURN', 'LOSS');
...
-- CreateIndex
CREATE UNIQUE INDEX "Supplier_businessId_document_key" ON "Supplier"("businessId", "document");
